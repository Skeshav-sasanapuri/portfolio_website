...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-[#e9e9e9] px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className={" min-h-screen"}>
          ...
          <div
            ...
            <Image src={keshavdp} alt={"Image of Keshav"} fill objectFit="cover"
                   className="object-cover object-[10%_center]"/> //if you want to scale image, add scale-100
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1">
              <Image src={web1} alt={"web1 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web2} alt={"web2 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web3} alt={"web3 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web4} alt={"web4 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web5} alt={"web5 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
            <div className="basis-1/3 flex-1">
              <Image src={web6} alt={"web6 image"} className="rounded-lg object-cover" width={'100%'} height={'100%'}
                     layout="responsive"/>
            </div>
          </div>
        </section>
